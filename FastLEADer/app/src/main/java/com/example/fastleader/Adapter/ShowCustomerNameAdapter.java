...
public class ShowCustomerNameAdapter extends RecyclerView.Adapter<ShowCustomerNameAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.CustomerName.setText("Name : "+data.getC_CustomerName());
        holder.CustomerMobileNo.setText("Mobile No : "+data.getC_MobileNumber());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Toast.makeText(context, "ccccc"+cn, Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra("CustomerName",cn);
                intent.putExtra("ShopName",data.getC_Company());
                intent.putExtra("Area",data.getC_Address());
